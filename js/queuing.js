...
class CastQueue extends cast.framework.QueueBase {
   ...
   */
  async initialize(loadRequestData) {
    throw new Error(
      "This error does not appear in the console, or seem to propogate, it is swallowed."
    );
   ...
   */
  async nextItems(referenceItemId) {
    throw new Error(
      "This error does not appear in the console, or seem to propogate, it is swallowed."
    );
   ...
   * @return {!Array<cast.framework.QueueItem>}
   */
  async prevItems(referenceItemId) {
    throw new Error(
      "This error does not appear in the console, or seem to propogate, it is swallowed."
    );
    // Return sample content.
